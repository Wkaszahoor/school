            ...
            return [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Leave Calendar', href: route('principal.leave.calendar'),      icon: CalendarIcon },
                        { label: 'Leave Settings', href: route('principal.leave.settings'),      icon: CalendarIcon },
            ...
            return [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Co-Scholastic Grades', href: route('teacher.co-scholastic.index'), icon: ClipboardDocumentCheckIcon },
                        ...
                        { label: 'Leave Calendar',   href: route('teacher.leave.calendar'), icon: CalendarIcon },
                        { label: 'Messages',         href: route('chat.index'),                icon: ChatBubbleLeftRightIcon },
                        { label: 'To-Do List',       href: route('todos.index'), icon: ClipboardDocumentListIcon },
                    ],
                },
