...
export default function Edit({ holiday, types }: Props) {
    const { data, setData, put, errors, processing } = useForm({
        name: holiday.name,
        holiday_date: holiday.holiday_date,
        holiday_type_id: holiday.holiday_type_id.toString(),
        description: holiday.description || '',
        duration: holiday.duration,
        academic_year: holiday.academic_year,
        is_gazetted: holiday.is_gazetted,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.holidays.update', holiday.id));
    };
