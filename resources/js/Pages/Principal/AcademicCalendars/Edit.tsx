...
export default function Edit({ event, academicYears }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('principal.academic-calendars.update', event.id));
    };

    return (
        <AppLayout title="Edit Academic Event">
            <Head title="Edit Academic Event" />
