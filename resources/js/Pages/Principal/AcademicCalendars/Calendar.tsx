...
export default function AcademicCalendarView({ events, year, academicYear, academicYears }: Props) {
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <div className="grid grid-cols-7">
                            {days.map((day, index) => {
                                const dayEvents = day ? getEventsForDate(day, currentMonth, currentYear) : [];
                                return (
                                    <div
                                        key={index}
                                                ...
                                                <div className="space-y-1">
                                                    {dayEvents.map((event) => (
                                                        <div
                                                            ...
                                                            style={{
                                                                backgroundColor: event.color || typeColors[event.type] || '#6B7280',
                                                            }}
                                                            title={event.title}
                                                        >
                                                            {event.title}
                                ...
                                return (
                                    <div key={type} className="flex items-center gap-2">
                                        <div
                                            ...
                                            style={{
                                                backgroundColor: event.color || typeColors[type] || '#6B7280',
                                            }}
                                        />
