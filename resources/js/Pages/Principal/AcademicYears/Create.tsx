...
export default function PrincipalCreateAcademicYear() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('principal.academic-years.store'));
    };
                ...
                <div className="space-y-5">
                    ...
                    <div className="card">
                        <div className="card-body space-y-3">
                            ...
                            <Link href={route('principal.academic-years.index')} className="btn-secondary w-full text-center">
                                Cancel
                            </Link>
                        </div>
                    </div>
