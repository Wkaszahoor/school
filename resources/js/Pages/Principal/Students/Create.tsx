...
export default function PrincipalCreateStudent({ classes, groups }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('principal.students.store'));
    };
            ...
            <div className="page-header">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="page-subtitle">Register a new student</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    <div className="lg:col-span-2 space-y-5">
                        <div className="card">
                            ...
                            <div className="card-body space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    {groups.length > 0 && isEligibleForGroup && (
                                        <div className="form-group">
                                            <label className="form-label">Subject Group <span className="text-blue-500 text-xs">(Classes 9-12)</span></label>
                                            <select className="form-select" value={data.subject_group_id}
                                                    onChange={e => setData('subject_group_id', e.target.value)}>
                                                <option value="">None</option>
                                                {groups.map(g => (
                                                    <option key={g.id} value={g.id}>{g.group_name} {g.stream && `(${g.stream})`}</option>
                                                ))}
                                            </select>
                                            {errors.subject_group_id && <p className="form-error">{errors.subject_group_id}</p>}
                                        </div>
                                    )}
                                    <div className="form-group">
                        ...
                        <div className="card">
                            <div className="card-header"><p className="card-title">Guardian &amp; Contact</p></div>
                            <div className="card-body space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="form-group col-span-2">
                        ...
                        <div className="card">
                            <div className="card-header"><p className="card-title">Trust Notes</p></div>
                            <div className="card-body space-y-4">
                                <div className="form-group">
                    ...
                    <div>
                        <div className="card">
                            <div className="card-header"><p className="card-title">Admit Student</p></div>
                            <div className="card-body space-y-3">
                                ...
                                <Link href={route('principal.students.index')} className="btn-secondary w-full text-center">
                                    Cancel
                                </Link>
                            </div>
                        </div>
