...
export default function ImportStudents({ classes }: Props) {
    ...
    const handleImport = () => {
        ...
        post(route('receptionist.import-students.store'), {
            data: { students },
            onError: () => {
    ...
    const downloadTemplate = () => {
        const validClasses = classes.map(c => c.class).join(', ');
        const template = [
            {
                'ID': '',
                'Photo': '',
            ...
            },
            {
                'ID': '',
                'Photo': '',
                'Student_Name': 'Valid Classes: ' + validClasses,
                'Student_CNIC': '',
                'Father_Name': '',
                'Father_CNIC': '',
                'Mother_Name': '',
                ...
                'Favorite_Subject': '',
                'Ambition': '',
                'Class': '(use one of the values shown)',
                'Course': '',
                'Semester': '',
                'Joining_Date': '',
                'Gender': '',
                        ...
                        <div className="card-body text-sm space-y-2">
                            ...
                            <p className="text-gray-700">
                                ...
                                <span className="text-xs text-gray-600">
                                    Valid options: {classes.map(c => c.class).join(', ')}
                                </span>
                            </p>
                        </div>
                    </div>
