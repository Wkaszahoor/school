import{r as m,j as t,H as g}from"./app-DQAHeJkO.js";import{F as b}from"./PrinterIcon-Dg1F1PL9.js";/* empty css            */const s=r=>r>=80?"text-emerald-600":r>=70?"text-emerald-500":r>=60?"text-blue-600":r>=50?"text-amber-600":"text-red-600",h=r=>r>=80||r>=70?"bg-emerald-50":r>=60?"bg-blue-50":r>=50?"bg-amber-50":"bg-red-50",u=r=>r==="PASS"?"bg-gradient-to-r from-emerald-100 to-green-100":"bg-gradient-to-r from-red-100 to-rose-100",y=r=>r==="PASS"?"text-emerald-800":"text-red-800",f=r=>r.split(" ").map(i=>i[0]).join("").toUpperCase().slice(0,2);function k({reportData:r,filters:i,examTypes:d,terms:o,classes:a}){const[j,l]=m.useState(null),x=()=>window.print(),c=i.class_id&&a.find(e=>e.id===Number(i.class_id))?`${a.find(e=>e.id===Number(i.class_id))?.class}${a.find(e=>e.id===Number(i.class_id))?.section?` — ${a.find(e=>e.id===Number(i.class_id))?.section}`:""}`:"All Classes";return t.jsxs(t.Fragment,{children:[t.jsx(g,{title:"Report Cards",children:t.jsx("style",{children:`
                    @media print {
                        * {
