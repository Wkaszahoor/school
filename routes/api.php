...
Route::middleware(['auth:sanctum', 'role:admin'])->prefix('v1/admin')->group(function () {
    ...
    // Holidays
    Route::get('/holidays', [Admin\HolidayController::class, 'apiIndex']);
    Route::post('/holidays', [Admin\HolidayController::class, 'apiStore']);
    Route::get('/holidays/{holiday}', [Admin\HolidayController::class, 'apiShow']);
    Route::put('/holidays/{holiday}', [Admin\HolidayController::class, 'apiUpdate']);
    Route::delete('/holidays/{holiday}', [Admin\HolidayController::class, 'apiDestroy']);

    // Academic Years
    Route::get('/academic-years', [Admin\AcademicYearsController::class, 'apiIndex']);
    Route::post('/academic-years', [Admin\AcademicYearsController::class, 'apiStore']);
    Route::get('/academic-years/{academicYear}', [Admin\AcademicYearsController::class, 'apiShow']);
    Route::put('/academic-years/{academicYear}', [Admin\AcademicYearsController::class, 'apiUpdate']);
    Route::delete('/academic-years/{academicYear}', [Admin\AcademicYearsController::class, 'apiDestroy']);
});
